        ...
        <form onSubmit={handleSubmit(submit)} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full p-4 bg-gray-800 text-white border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.email ? 'border-red-600' : ''}`}
              {...register('email', {
          ...
          <div>
            ...
            <input
              ...
              className={`w-full p-4 bg-gray-800 text-white border border-gray-300  rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.password ? 'border-red-600' : ''}`}
              {...register('password', {
